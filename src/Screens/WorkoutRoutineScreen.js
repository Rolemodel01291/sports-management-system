...
class WorkoutRoutineScreen extends React.Component{   
    ...
    goGameTrackerList = (id) => {
        ...
        this.props.navigation.navigate("WorkoutRoutineList")
    }
    render(){
        console.log("============",this.props.profiles)
        return(
...
export default connect(mapStateToProps, mapDispatchToProps)(WorkoutRoutineScreen);
